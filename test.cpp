...
#define AbdurRahman    ios::sync_with_stdio(false); cin.tie(nullptr); cout.tie(nullptr);
...
static uint16_t internet_checksum_stub(const array<int, 4> &b)
{
...
void solve()
{
    array<int, 4> input = {239, 176, 240, 243};
    internet_checksum_stub(input);
    int x = 0xFFFF;
    cout << x << endl;
}
